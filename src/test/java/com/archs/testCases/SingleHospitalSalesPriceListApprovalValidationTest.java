...
public class SingleHospitalSalesPriceListApprovalValidationTest extends TestBase {
	...
	@Test
	public void SingleHSPriceListApprovalValidationTest() throws InterruptedException, TimeoutException
	{
		...
		Thread.sleep(1000);
		hsplp.clickOnRBCFrozenPrice();
		hsplp.setApprovalComment(plApprovalComment);
