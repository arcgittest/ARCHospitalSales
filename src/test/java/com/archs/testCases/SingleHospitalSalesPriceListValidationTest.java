...
public class SingleHospitalSalesPriceListValidationTest extends TestBase {
	...
	@Test
	public void SingleHSPriceListValidationTest() throws InterruptedException, TimeoutException
	{
		...
		float expectedSecondYearLrrbcPrice = hsplp.getLrbcPriceSpan();
		Thread.sleep(1000);
		...
		float actualSecondYearLrrbcPrice = hsplp.getSecondLrbcPriceSpan();
		Thread.sleep(1000);
		Assert.assertEquals(actualSecondYearLrrbcPrice, expectedSecondYearLrrbcPrice);
		
		
		
		hsplp.clickOnSecondNextButton();
		float actualThirdYearLrrbcPrice = hsplp.getSecondYearTwoPercentLrbcPriceSpan();
		Thread.sleep(1000);
		hsplp.clickOnSecondEscalateButton();
		hsplp.clickOnSecondApplyAllButton();
		
		float expectedThirdYearLrrbcPrice = hsplp.getThirdLrbcPriceSpan();
		Thread.sleep(9000);
		Assert.assertEquals(actualThirdYearLrrbcPrice, expectedThirdYearLrrbcPrice);
